                ...
                <div className='grid grid-cols-3 grid-rows-3'>
                    ...
                    <div className='bg-white my-2 col-span-3 p-4'>
                        ...
                        <div className='flex items-center justify-around gap-4 '>
                            <div  >
                                <button className='py-7 px-10 bg-[#f7fafc] cursor-pointer'  onClick={() => { handleListArray(item,"Call") }}><Phone />
                                    Call
                                </button>
                            </div>
                            <div  >
                                <button className='py-7 px-10 bg-[#f7fafc] cursor-pointer' onClick={() => { handleListArray(item,"Text") }}><MessageSquareMore />
                                    Text
                                </button>
                            </div>
                            <div  >
                                <button className='py-7 px-10 bg-[#f7fafc] cursor-pointer' onClick={() => { handleListArray(item,"Video") }}><Video />Video
                                </button>
                            </div>
                        </div>
